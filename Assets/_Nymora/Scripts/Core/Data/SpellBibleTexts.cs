    ...
    public static class SpellBibleTexts
    {
        ...
        public static readonly IReadOnlyList<Entry> Entries = new List<Entry>
        {
            ...
            new Entry { SpellIdValue = 11, SpellIdTech = "soulrender_ouvre_plaie",          ClassId = NymoraClass.Soulrender, Category = SpellCategory.Offensive, DisplayName = "Ouvre-Plaie",
                Description = "Inflige {DMG:110} dégâts. Si tu as au moins 1 HG (dépensé automatiquement) : 230 dégâts ET les soins et boucliers reçus par la cible sont réduits de moitié (÷2) pendant 1 tour. Cap : 1 fois par tour.",
            ...
            new Entry { SpellIdValue = 15, SpellIdTech = "soulrender_pacte_de_sang",        ClassId = NymoraClass.Soulrender, Category = SpellCategory.Tactical,  DisplayName = "Pacte de Sang",
                Description = "Le Soulrender s'inflige 80 dégâts à lui-même et gagne +2 HG immédiatement. Son prochain sort offensif ce tour gagne +25% de dégâts. UTILISABLE 1 FOIS PAR MATCH.",
            ...
            new Entry { SpellIdValue = 17, SpellIdTech = "soulrender_empoignade",           ClassId = NymoraClass.Soulrender, Category = SpellCategory.Tactical,  DisplayName = "Empoignade",
                Description = "EN LIGNE DROITE uniquement (même ligne ou même colonne). Inflige 90 dégâts, tire la cible jusqu'à 1 case du Soulrender (corps à corps) et lui retire 2 PM à son prochain tour. Cap : 1 fois par tour.",
            ...
            new Entry { SpellIdValue = 19, SpellIdTech = "soulrender_rage_insatiable",      ClassId = NymoraClass.Soulrender, Category = SpellCategory.Tactical,  DisplayName = "Frénésie",
                Description = "Pendant 2 tours, chaque sort OFFENSIF lancé par le Soulrender gagne +5% de dégâts ET génère +1 HG. (Recast = rafraîchit la durée, pas de cumul.)",
            ...
            new Entry { SpellIdValue = 21, SpellIdTech = "soulrender_cauterisation",        ClassId = NymoraClass.Soulrender, Category = SpellCategory.Survival,  DisplayName = "Sang Bouillant",
                Description = "Pendant 2 tours, chaque fois que le Soulrender SUBIT des dégâts : il gagne +1 HG et sa prochaine frappe inflige +15 dégâts. (Recast = rafraîchit, pas de cumul.)",
            ...
            new Entry { SpellIdValue = 22, SpellIdTech = "soulrender_peau_de_fer",          ClassId = NymoraClass.Soulrender, Category = SpellCategory.Survival,  DisplayName = "Peau de Fer",
                Description = "Le Soulrender gagne un BOUCLIER de 200 HP pendant 2 tours. Pendant la durée du bouclier, ses sorts à portée 1 (mêlée) gagnent +10 dégâts. Le bouclier se vide normalement aux dégâts subis. Relance : 2 tours.",
            ...
            new Entry { SpellIdValue = 24, SpellIdTech = "soulrender_dernier_souffle",      ClassId = NymoraClass.Soulrender, Category = SpellCategory.Survival,  DisplayName = "Dernier Souffle",
                Description = "Utilisable uniquement à <50% HP (2 PA). Le Soulrender se soigne de 200 HP ET gagne 3 HG. UTILISABLE 1 FOIS PAR MATCH.",
            ...
            new Entry { SpellIdValue = 31, SpellIdTech = "nightseer_volee_epines",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Offensive, DisplayName = "Volée d'Épines",
                Description = "Tir en ligne droite. Inflige {DMG:130} dégâts à toutes les cibles touchées. Pose un Filet de Ronces (100 dégâts, -1 PM, applique TRAQUÉ au déclenchement) une case DERRIÈRE la dernière cible touchée, dans le sens du tir. Le piège disparaît au bout de 6 tours. Cap : 1 fois par tour.",
            ...
            new Entry { SpellIdValue = 33, SpellIdTech = "nightseer_frappe_ombre",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Offensive, DisplayName = "Frappe de l'Ombre",
                Description = "Inflige {DMG:160} dégâts. Si la cible est TRAQUÉ : +120 dégâts (= 280) et consomme TRAQUÉ.",
            ...
            new Entry { SpellIdValue = 35, SpellIdTech = "nightseer_marque_chasseur",       ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Affût",
                Description = "Auto-buff : le Nightseer gagne +2 de PORTÉE sur ses sorts à distance et +10% de dégâts pendant 2 tours. Génère +1 PR. Relance : 3 tours. INDISPONIBLE AU TOUR 1.",
            ...
            new Entry { SpellIdValue = 36, SpellIdTech = "nightseer_filet_ronces",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Filet de Ronces",
                Description = "Pose une embûche VISIBLE sur une case (invisible seulement si le Nightseer est en phase 3). Toute unité ennemie qui entre : 100 dégâts, -1 PM, et applique TRAQUÉ. Le piège disparaît au bout de 6 tours. UTILISABLE 1 FOIS PAR TOUR.",
            ...
            new Entry { SpellIdValue = 37, SpellIdTech = "nightseer_champ_mines",           ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Champ de Mines",
                Description = "Pose 3 embûches VISIBLES dans une zone 3x3 (invisibles seulement en phase 3). Chaque embûche : 70 dégâts + applique TRAQUÉ. Les mines disparaissent au bout de 6 tours. Cap : 1 fois par tour.",
            ...
            new Entry { SpellIdValue = 39, SpellIdTech = "nightseer_souffle_glacial",       ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Piège Bondissant",
                Description = "Pose un piège-catapulte sur une case (portée 4). Au déclenchement, l'ennemi est ÉJECTÉ de 3 cases dans la direction choisie à la pose (2e clic) et devient Traqué. Pas de dégâts directs. Le piège disparaît au bout de 6 tours. Cap : 1 fois par tour.",
            ...
            new Entry { SpellIdValue = 40, SpellIdTech = "nightseer_voile_ombre",           ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Repli Épineux",
                Description = "Auto. Repousse de 2 cases TOUS les ennemis adjacents (corps à corps) et soigne le Nightseer de 100 HP. Relance : 2 tours.",
            ...
            new Entry { SpellIdValue = 41, SpellIdTech = "nightseer_pas_furtif",            ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Pas Furtif",
                Description = "Téléporte le Nightseer jusqu'à 3 cases (coûte 3 PA). Si tu as au moins 1 PR (dépensée automatiquement) : pose un Filet de Ronces sur la case quittée (disparaît au bout de 6 tours). UTILISABLE 1 FOIS PAR TOUR, RELANCE 1 TOUR. INDISPONIBLE AU TOUR 1.",
            ...
            new Entry { SpellIdValue = 44, SpellIdTech = "nightseer_evanescence",           ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Évanescence",
                Description = "Utilisable uniquement à <50% HP (2 PA). Le Nightseer se téléporte jusqu'à 7 cases, se soigne de 150 HP ET pose un Filet de Ronces sur la case quittée (disparaît au bout de 6 tours). UTILISABLE 1 FOIS PAR MATCH.",
            ...
            new Entry { SpellIdValue = 50, SpellIdTech = "colossar_frappe_lourde",          ClassId = NymoraClass.Colossar, Category = SpellCategory.Offensive, DisplayName = "Frappe Lourde",
                Description = "Inflige 180 dégâts. Si la cible est ÉPINGLÉE (adjacente à un Pilier, mur, ou bord de map du côté opposé au Colossar) : 280 dégâts. Cap : 2 fois par tour.",
            ...
            new Entry { SpellIdValue = 51, SpellIdTech = "colossar_onde_de_choc",           ClassId = NymoraClass.Colossar, Category = SpellCategory.Offensive, DisplayName = "Onde de Choc",
                Description = "AoE autour du Colossar. Inflige 80 dégâts à toutes les unités adjacentes ET les pousse de 2 cases. Si une unité est poussée contre un mur, Pilier, ou bord de map : 80 dégâts supplémentaires + APPLIQUE TRAUMA (-1 PM, -1 PA pendant 1 tour). Cap : 2 fois par tour.",
            ...
            new Entry { SpellIdValue = 54, SpellIdTech = "colossar_represailles",           ClassId = NymoraClass.Colossar, Category = SpellCategory.Survival, DisplayName = "Représailles",
                Description = "UTILISABLE SEULEMENT SOUS 50% DE PV, 1 FOIS PAR MATCH. Coûte 2 PA. Le Colossar se soigne de 200 HP en urgence. Pendant 1 tour, chaque attaque mêlée subie renvoie 50 dégâts à l'attaquant (cap 2 retours).",
            ...
            new Entry { SpellIdValue = 55, SpellIdTech = "colossar_pilier",                 ClassId = NymoraClass.Colossar, Category = SpellCategory.Tactical,  DisplayName = "Pilier",
                Description = "Pose un Pilier (200 HP, infranchissable, occupe 1 case) sur une case vide. Reste jusqu'à destruction. Le Colossar gagne +1 FD à la pose. Le Pilier bloque les lignes de vue et de tir des sorts directs. MAXIMUM 6 CASES d'obstacle (Piliers + Murs) sur la map : au-delà, le plus ancien est automatiquement détruit (un numéro d'ordre s'affiche sur chacun).",
            ...
            new Entry { SpellIdValue = 56, SpellIdTech = "colossar_mur_de_pierre",          ClassId = NymoraClass.Colossar, Category = SpellCategory.Tactical,  DisplayName = "Mur de Pierre",
                Description = "Crée un mur infranchissable de 3 cases (en ligne) — 5 cases si tu as au moins 1 FD (dépensé automatiquement). Reste jusqu'à destruction (plus de durée limitée). Le Colossar gagne +2 FD à la pose. Le Mur bloque tout : déplacements, ciblages directs, lignes de tir. Chaque case compte dans le MAXIMUM de 6 cases d'obstacle (au-delà, le plus ancien est détruit). Cap : 1×/tour, relance 2 tours.",
            ...
            new Entry { SpellIdValue = 57, SpellIdTech = "colossar_ancrage",                ClassId = NymoraClass.Colossar, Category = SpellCategory.Tactical,  DisplayName = "Ancrage",
                Description = "La cible perd 1 PM pendant 2 tours ET ne peut pas être déplacée par effets externes (push/pull/téléport) au prochain tour. Pas de dégâts. Cap : 1×/tour, relance 3 tours.",
            ...
            new Entry { SpellIdValue = 58, SpellIdTech = "colossar_provocation",            ClassId = NymoraClass.Colossar, Category = SpellCategory.Tactical,  DisplayName = "Provocation",
                Description = "Force la cible à tenter d'attaquer le Colossar pendant 1 tour : TOUS ses sorts coûtent +1 PA. Si la cible n'est pas adjacente au Colossar à la fin de son tour : 100 dégâts auto. Relance : 2 tours.",
            ...
            new Entry { SpellIdValue = 60, SpellIdTech = "colossar_stoicisme",              ClassId = NymoraClass.Colossar, Category = SpellCategory.Survival,  DisplayName = "Stoïcisme",
                Description = "Le Colossar gagne un BOUCLIER de 200 HP pour 2 tours. Pendant 1 tour, il ne peut PAS être déplacé (push/pull/téléport ennemi sans effet). Si le bouclier survit aux 2 tours sans être brisé, le Colossar récupère 80 HP.",
            ...
            new Entry { SpellIdValue = 63, SpellIdTech = "colossar_renvoi_bouclier",        ClassId = NymoraClass.Colossar, Category = SpellCategory.Survival,  DisplayName = "Renvoi du Bouclier",
                Description = "Coûte 2 PA. Pendant 1 tour, toute attaque (mêlée OU à distance) subie par le Colossar renvoie 60 dégâts à l'attaquant. Cap à 2 retours. Relance : 1 tour.",
            ...
            new Entry { SpellIdValue = 74, SpellIdTech = "necram_brume_toxique",            ClassId = NymoraClass.Necram, Category = SpellCategory.Offensive, DisplayName = "Brume Toxique",
                Description = "Pose une zone toxique 3x3 pendant 2 tours (superposable). Toute unité ennemie dans la zone (à la pose, en entrant, ou en finissant son tour) prend +1 marque de venin, et perd 1 PM si elle démarre son tour dedans. Tant qu'une unité tient dans la Brume, ses dégâts de venin par tour sont MAJORÉS (+10 par marque). Pas de dégâts directs. Cap : 1×/tour, relance 2 tours.",
            ...
            new Entry { SpellIdValue = 84, SpellIdTech = "necram_cocon_putride",            ClassId = NymoraClass.Necram, Category = SpellCategory.Survival,  DisplayName = "Cocon Putride",
                Description = "Utilisable uniquement à <50% HP (2 PA). Le Necram se soigne de 220 HP ET applique 1 marque à toutes les unités ennemies dans rayon 4. UTILISABLE 1 FOIS PAR MATCH.",
            ...
            new Entry { SpellIdValue = 93, SpellIdTech = "ghostra_eveil_spectral",          ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Éveil Spectral",
                Description = "Téléporte un de tes leurres sur une case libre adjacente à la cible (dans son dos en priorité) PUIS le fait la poignarder pour 100 dégâts. Le bonus dorsal et la PLAIE OUVERTE sont calculés depuis la position du leurre (un leurre dans le dos = frappe dorsale). Le leurre n'est pas consommé. Requiert au moins 1 leurre actif ET une case libre adjacente à la cible. UTILISABLE 2 FOIS PAR TOUR.",
            ...
            new Entry { SpellIdValue = 97, SpellIdTech = "ghostra_voile_spectral",          ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Voile Spectral",
                Description = "Téléporte tous tes leurres actifs sur des cases libres autour de l'ennemi ciblé (collés à lui en priorité). Chaque leurre désormais adjacent à la cible lui inflige 60 dégâts (max 180 = 3 leurres collés). Prépare aussi tes frappes dorsales (Éveil Spectral, Nuée). Requiert au moins 1 leurre actif. UTILISABLE 1 FOIS PAR TOUR.",
            ...
            new Entry { SpellIdValue = 99, SpellIdTech = "ghostra_dernier_pas",             ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Dernier Pas",
                Description = "Utilisable uniquement à <50% HP (2 PA). La Ghostra se soigne de 200 HP, se téléporte jusqu'à 5 cases, ET pose un leurre sur la case quittée. UTILISABLE 1 FOIS PAR MATCH.",
