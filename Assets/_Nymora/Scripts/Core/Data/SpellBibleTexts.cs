    ...
    public static class SpellBibleTexts
    {
        ...
        public static readonly IReadOnlyList<Entry> Entries = new List<Entry>
        {
            ...
            new Entry { SpellIdValue = 89, SpellIdTech = "ghostra_pas_dans_ombre",          ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Pas dans l'Ombre",
                Description = "Téléporte la Ghostra jusqu'à 5 cases. Si une case adjacente à l'arrivée contient une cible ennemie : la cible PIVOTE pour faire face à la Ghostra. Coût optionnel : laisser un leurre sur la case quittée (compte dans le cap 3). UTILISABLE 1 FOIS PAR TOUR.",
            ...
            new Entry { SpellIdValue = 90, SpellIdTech = "ghostra_permutation",            ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Permutation",
                Description = "Échange instantanément la position de la Ghostra avec un de ses leurres ciblé (jusqu'à 4 cases), dès 1 leurre actif. Aucun dégât. Échange invisible côté adversaire (silhouettes identiques). UTILISABLE 2 FOIS PAR TOUR.",
            ...
            new Entry { SpellIdValue = 93, SpellIdTech = "ghostra_dague_lancee",            ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Dague Lancée",
                Description = "Inflige 40 dégâts + bonus dorsal Angle Mort si applicable. Fait pivoter la cible de 90° (sens horaire). Prépare le combo Dague Lancée → Frappe Fantôme (Plaie Ouverte).",
            ...
            new Entry { SpellIdValue = 98, SpellIdTech = "ghostra_replique_protectrice",    ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Réplique Protectrice",
                Description = "Pose un Leurre PROTECTEUR (200 HP, redirige 30% des dégâts subis par la Ghostra pendant 3 rounds). Si le Leurre est détruit, la Ghostra regagne 80 HP. Pas de stack si plusieurs Protective vivants (un seul absorbe par hit). Compte dans le cap 3 leurres. UTILISABLE 1 FOIS PAR TOUR.",
