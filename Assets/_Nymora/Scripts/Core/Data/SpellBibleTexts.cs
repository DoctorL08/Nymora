    ...
    public static class SpellBibleTexts
    {
        ...
        public static readonly IReadOnlyList<Entry> Entries = new List<Entry>
        {
            ...
            new Entry { SpellIdValue = 98, SpellIdTech = "ghostra_replique_protectrice",    ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Réplique Protectrice",
                Description = "Pose un Leurre PROTECTEUR (250 HP, redirige 30% des dégâts subis par la Ghostra pendant 4 rounds). Si le Leurre est détruit, la Ghostra regagne 80 HP. Pas de stack si plusieurs Protective vivants (un seul absorbe par hit). Compte dans le cap 3 leurres. UTILISABLE 1 FOIS PAR TOUR.",
