    ...
    public static class SpellBibleTexts
    {
        ...
        public static readonly IReadOnlyList<Entry> Entries = new List<Entry>
        {
            ...
            new Entry { SpellIdValue = 36, SpellIdTech = "nightseer_filet_ronces",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Filet de Ronces",
                Description = "Pose une embûche VISIBLE sur une case (invisible seulement si le Nightseer est en phase 3). Toute unité ennemie qui entre : 100 dégâts, -1 PM, et applique TRAQUÉ. UTILISABLE 1 FOIS PAR TOUR.",
            ...
            new Entry { SpellIdValue = 41, SpellIdTech = "nightseer_pas_furtif",            ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Pas Furtif",
                Description = "Téléporte le Nightseer jusqu'à 3 cases (coûte 3 PA). Si tu as au moins 1 PR (dépensée automatiquement) : pose un Filet de Ronces sur la case quittée. UTILISABLE 1 FOIS PAR TOUR, RELANCE 1 TOUR. INDISPONIBLE AU TOUR 1.",
