    ...
    public static class SpellBibleTexts
    {
        ...
        public static readonly IReadOnlyList<Entry> Entries = new List<Entry>
        {
            ...
            new Entry { SpellIdValue = 11, SpellIdTech = "soulrender_ouvre_plaie",          ClassId = NymoraClass.Soulrender, Category = SpellCategory.Offensive, DisplayName = "Ouvre-Plaie",
                Description = "Inflige 110 dégâts. SI 1 HG dépensé : 230 dégâts ET la cible ne peut pas se soigner ni recevoir de bouclier pendant 2 tours.",
            ...
            new Entry { SpellIdValue = 12, SpellIdTech = "soulrender_charge_brutale",       ClassId = NymoraClass.Soulrender, Category = SpellCategory.Offensive, DisplayName = "Charge Brutale",
                Description = "Le Soulrender fonce en ligne droite jusqu'à la première unité ou case bloquante. Inflige 180 dégâts à la cible touchée. Toute case foulée pendant la charge devient Vapeur Carmin pendant 1 tour.",
            ...
            new Entry { SpellIdValue = 13, SpellIdTech = "soulrender_detonation_sanglante", ClassId = NymoraClass.Soulrender, Category = SpellCategory.Offensive, DisplayName = "Détonation Sanglante",
                Description = "Centre AoE croix 3. Inflige 60 dégâts de base à toutes les cibles dans la zone, +40 par HG consommé. Avec 5 HG : 260 dégâts. Sang Coagulé créé sous le centre pendant 2 tours. ATTENTION : consommer 5 HG ici interdit Âme Lacérée et reset son cooldown.",
                LoreFlavor  = "Le payoff total. Détoner 5 HG est un acte de FOI — le Soulrender renonce à son finisher pour un coup massif." },
            new Entry { SpellIdValue = 14, SpellIdTech = "soulrender_curee",                ClassId = NymoraClass.Soulrender, Category = SpellCategory.Offensive, DisplayName = "Curée",
                Description = "Inflige 150 dégâts. SI la cible meurt sur ce sort : le Soulrender heal 50% de ses HP max manquants ET récupère 4 PA pour le tour suivant. Si la cible NE MEURT PAS : le Soulrender perd 60 HP.",
            ...
            new Entry { SpellIdValue = 16, SpellIdTech = "soulrender_marque_de_carnage",    ClassId = NymoraClass.Soulrender, Category = SpellCategory.Tactical,  DisplayName = "Marque de Carnage",
                Description = "Marque la cible 3 tours. Pendant ce temps, tous les sorts du Soulrender sur cette cible génèrent +1 HG bonus. La marque est visible sur le sprite ennemi (croix de sang).",
            ...
            new Entry { SpellIdValue = 17, SpellIdTech = "soulrender_empoignade",           ClassId = NymoraClass.Soulrender, Category = SpellCategory.Tactical,  DisplayName = "Empoignade",
                Description = "Tire la cible jusqu'à 1 case du Soulrender. La cible ne peut pas être téléportée par un de ses propres sorts au tour suivant. Pas de dégâts.",
            ...
            new Entry { SpellIdValue = 18, SpellIdTech = "soulrender_rugissement",          ClassId = NymoraClass.Soulrender, Category = SpellCategory.Tactical,  DisplayName = "Rugissement",
                Description = "AoE rayon 3 autour du Soulrender. Toutes les cibles ennemies subissent -1 PM ET ne peuvent pas téléporter au tour suivant. Si une cible est sous 50% HP : -2 PM au lieu de -1. Pas de dégâts.",
            ...
            new Entry { SpellIdValue = 19, SpellIdTech = "soulrender_rage_insatiable",      ClassId = NymoraClass.Soulrender, Category = SpellCategory.Tactical,  DisplayName = "Rage Insatiable",
                Description = "Pendant 2 tours, chaque sort offensif lancé par le Soulrender regenère 1 PA (max 1 par tour). Les sorts coûtent 1 PA de plus pendant ces 2 tours.",
                LoreFlavor  = "Le cycle ouvert. Rage Insatiable est un investissement : on accepte de payer plus cher chaque sort, en échange d'un tempo qui ne s'arrête jamais." },
            ...
            new Entry { SpellIdValue = 21, SpellIdTech = "soulrender_cauterisation",        ClassId = NymoraClass.Soulrender, Category = SpellCategory.Survival,  DisplayName = "Cautérisation",
                Description = "Retire instantanément tous les DoT actifs sur le Soulrender (poison, plaie ouverte, autres saignements ennemis). Le Soulrender se soigne de 60 HP par DoT retiré (min 60, max 180).",
                LoreFlavor  = "L'auto-cautérisation. Anti-Necram et anti-Ghostra. Quand le bleed devient trop dense, le Soulrender brûle ses propres plaies pour repartir." },
            new Entry { SpellIdValue = 22, SpellIdTech = "soulrender_peau_de_fer",          ClassId = NymoraClass.Soulrender, Category = SpellCategory.Survival,  DisplayName = "Peau de Fer",
                Description = "Le Soulrender gagne un BOUCLIER de 200 HP pendant 2 tours. Pendant la durée du bouclier, ses sorts à portée 1 (mêlée) gagnent +30 dégâts. Le bouclier se vide normalement aux dégâts subis.",
            ...
            new Entry { SpellIdValue = 23, SpellIdTech = "soulrender_seve_vive",            ClassId = NymoraClass.Soulrender, Category = SpellCategory.Survival,  DisplayName = "Sève Vive",
                Description = "Le Soulrender se soigne de 100 HP. Avec 1 HG : 160 HP. Si le Soulrender saigne actuellement (DoT actif sur lui) : +50 HP additionnels.",
            ...
            new Entry { SpellIdValue = 30, SpellIdTech = "nightseer_tir_precis",            ClassId = NymoraClass.Nightseer, Category = SpellCategory.Offensive, DisplayName = "Tir Précis",
                Description = "Inflige 200 dégâts. Si la cible est Traqué : 280 dégâts ET le Nightseer regagne 1 PR.",
                LoreFlavor  = "Le sniper. Tir Précis n'a pas besoin de surprendre — sa simple existence à 6 cases force l'adversaire à toujours regarder en l'air." },
            new Entry { SpellIdValue = 31, SpellIdTech = "nightseer_volee_epines",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Offensive, DisplayName = "Volée d'Épines",
                Description = "Tir en ligne droite. Inflige 130 dégâts à toutes les cibles touchées. Pose un Filet de Ronces (identique au sort tactique : 100 dégâts, -2 PM, applique EMPREINTÉ 2 tours au déclenchement) sur la dernière case touchée.",
            ...
            new Entry { SpellIdValue = 32, SpellIdTech = "nightseer_detonation_onirique",   ClassId = NymoraClass.Nightseer, Category = SpellCategory.Offensive, DisplayName = "Détonation Onirique",
                Description = "AoE 2x2 cases. 170 dégâts dans la zone. Si une case Voilé existe dans la zone, elle se déchire et inflige 80 dégâts supplémentaires. Avec 2 PR : portée passe à 10, peut frapper depuis l'autre côté de la map.",
            ...
            new Entry { SpellIdValue = 33, SpellIdTech = "nightseer_frappe_ombre",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Offensive, DisplayName = "Frappe de l'Ombre",
                Description = "Inflige 200 dégâts. Si la cible a moins de 50% de ses PM max actuels (donc s'est déjà déplacée) : +100 dégâts ET applique EMPREINTÉ pour 2 tours.",
                LoreFlavor  = "L'archer immobile. Frappe de l'Ombre punit le mouvement. Les classes qui sprintent (Ghostra, Soulrender qui charge) se font shred." },
            new Entry { SpellIdValue = 34, SpellIdTech = "nightseer_salve_mortelle",        ClassId = NymoraClass.Nightseer, Category = SpellCategory.Offensive, DisplayName = "Salve Mortelle",
                Description = "Cible une case. Centre + 4 cases adjacentes en croix : 220 dégâts au centre, 130 sur les côtés. Toute cible Traqué dans la zone : +60 dégâts. Toute case Voilé dans la zone : déchirée, dévoilée, +50 dégâts à qui s'y trouvait. ATTENTION : consommer 3 PR ici diffère le cooldown du Traquenard.",
            ...
            new Entry { SpellIdValue = 35, SpellIdTech = "nightseer_marque_chasseur",       ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Marque du Chasseur",
                Description = "Applique TRAQUÉ à la cible pendant 3 tours. Sort très peu cher car le payoff est dans les autres sorts. Coexiste avec Voilé/Empreinté sur d'autres cibles, pas sur la même.",
            ...
            new Entry { SpellIdValue = 36, SpellIdTech = "nightseer_filet_ronces",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Filet de Ronces",
                Description = "Pose une embûche invisible sur une case (Voilé pour l'adversaire). Toute unité ennemie qui entre : 100 dégâts, -2 PM, et applique EMPREINTÉ pour 2 tours.",
            ...
            new Entry { SpellIdValue = 37, SpellIdTech = "nightseer_champ_mines",           ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Champ de Mines",
                Description = "Pose 3 embûches Voilées dans une zone 3x3 (placement aléatoire pour l'adversaire, choisi par le Nightseer). Chaque embûche : 70 dégâts + applique EMPREINTÉ.",
            ...
            new Entry { SpellIdValue = 38, SpellIdTech = "nightseer_bourrasque",            ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Bourrasque",
                Description = "Pousse la cible 3 cases dans la direction choisie. Avec 1 PR : 5 cases. Si la cible finit sa course sur un Filet de Ronces, une mine, ou une case Sang Coagulé : effets déclenchés à pleine puissance.",
            ...
            new Entry { SpellIdValue = 39, SpellIdTech = "nightseer_souffle_glacial",       ClassId = NymoraClass.Nightseer, Category = SpellCategory.Tactical,  DisplayName = "Souffle Glacial",
                Description = "AoE croix 3 cases autour du Nightseer. Inflige 70 dégâts + push 1 case + applique -1 PM aux cibles. Si une cible est poussée sur un Filet/mine : déclenchement.",
                LoreFlavor  = "Le décrochage. Souffle Glacial est l'outil anti-mêlée. Quand un Soulrender colle au Nightseer, ce sort le repousse ET le pousse potentiellement dans une mine voilée." },
            new Entry { SpellIdValue = 40, SpellIdTech = "nightseer_voile_ombre",           ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Voile d'Ombre",
                Description = "Le Nightseer disparaît visuellement de l'écran adversaire pendant 1 tour entier. Il ne peut pas être ciblé directement (les AoE non-ciblées passent toujours). Si on devine sa case par AoE : effet normal.",
                LoreFlavor  = "Le grand silence. Voile d'Ombre est l'arme du décrochage. Quand le Soulrender le pourchasse, le Nightseer disparaît juste avant le finisher." },
            new Entry { SpellIdValue = 41, SpellIdTech = "nightseer_pas_furtif",            ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Pas Furtif",
                Description = "Téléporte le Nightseer jusqu'à 4 cases. Si 1 PR consommée, la case d'arrivée devient VOILÉE pour l'adversaire pendant 2 tours.",
            ...
            new Entry { SpellIdValue = 43, SpellIdTech = "nightseer_seve_sauvage",          ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Sève Sauvage",
                Description = "Le Nightseer se soigne de 130 HP. Si une de ses embûches a été déclenchée ce tour ou le tour précédent : +60 HP additionnels. Si une case Voilée existe actuellement sur la map : +30 HP.",
            ...
            new Entry { SpellIdValue = 44, SpellIdTech = "nightseer_evanescence",           ClassId = NymoraClass.Nightseer, Category = SpellCategory.Survival,  DisplayName = "Évanescence",
                Description = "Utilisable uniquement à <30% HP. Le Nightseer se téléporte jusqu'à 7 cases ET se soigne de 150 HP. La case quittée devient Voilée pendant 2 tours. UTILISABLE 1 FOIS PAR MATCH.",
            ...
            new Entry { SpellIdValue = 45, SpellIdTech = "nightseer_traquenard",            ClassId = NymoraClass.Nightseer, Category = SpellCategory.Signature, DisplayName = "Traquenard",
                Description = "Le Nightseer se téléporte à 1 case de la cible (côté libre, choix du joueur). Inflige 280 dégâts. Applique PARALYSIE (-3 PM, -2 PA) au prochain tour de la cible. Si la cible était Traqué/Voilé/Empreinté avant le sort : +80 dégâts ET la marque est consommée pour générer 2 PR au Nightseer après le coup.",
            ...
            new Entry { SpellIdValue = 56, SpellIdTech = "colossar_mur_de_pierre",          ClassId = NymoraClass.Colossar, Category = SpellCategory.Tactical,  DisplayName = "Mur de Pierre",
                Description = "Crée un mur infranchissable de 3 cases (en ligne) pendant 2 tours. Avec 1 FD : 5 cases. Le Mur bloque tout : déplacements, ciblages directs, lignes de tir.",
            ...
            new Entry { SpellIdValue = 61, SpellIdTech = "colossar_garde_protectrice",      ClassId = NymoraClass.Colossar, Category = SpellCategory.Survival,  DisplayName = "Garde Protectrice",
                Description = "Pendant 2 tours, le Colossar subit -30% de dégâts de TOUTES les sources (sauf DoT venin Necram qui ignore les réductions). Ne se cumule pas avec le passif Densité Inerte au-delà du cap -50% total.",
            ...
            new Entry { SpellIdValue = 64, SpellIdTech = "colossar_soin_lourd",             ClassId = NymoraClass.Colossar, Category = SpellCategory.Survival,  DisplayName = "Soin Lourd",
                Description = "Soigne 150 HP sur soi OU sur un allié à 3 cases. UNIQUE HEAL CROSS-CLASSE DU JEU. En 1v1 : self-only, agit comme un heal lourd à 3 PA.",
                LoreFlavor  = "Le seul vrai support du jeu. Inutile en 1v1 sauf comme heal classique, mais son existence définit le rôle du Colossar en team. En 2v2/3v3 c'est un game-changer." },
            new Entry { SpellIdValue = 65, SpellIdTech = "colossar_effondrement",           ClassId = NymoraClass.Colossar, Category = SpellCategory.Signature, DisplayName = "Effondrement",
                Description = "ANNONCE 1 TOUR À L'AVANCE (le sol craque sous le Colossar à la fin du tour de cast — l'ennemi le voit). Au tour suivant : toutes les cases adjacentes au Colossar (rayon 2) deviennent IMPRATICABLES pendant 2 tours. Les ennemis dessus prennent 200 dégâts immédiats et sont éjectés vers la case libre la plus proche. Pendant les 2 tours d'Effondrement, le Colossar gagne +1 PM, ses sorts coûtent -1 PA, et toute attaque qu'il subit est réduite de 30%. À la fin de l'Effondrement, FD revient à 0.",
                LoreFlavor  = "L'arme tellurique. L'annonce 1 tour à l'avance crée un mindgame brutal : l'adversaire DOIT se repositionner ou prendre 200 dégâts. Pas de troisième option. Le Colossar dicte la prochaine demi-minute." },
            ...
            new Entry { SpellIdValue = 72, SpellIdTech = "necram_detonation_virulente",     ClassId = NymoraClass.Necram, Category = SpellCategory.Offensive, DisplayName = "Détonation Virulente",
                Description = "Inflige 80 dégâts immédiats. Consomme TOUTES les marques sur la cible : chaque marque consommée inflige 50 dégâts. Avec 4 marques : 280 dégâts totaux. Les marques disparaissent.",
                LoreFlavor  = "Le détonateur. Détonation est le moment où le Necram récolte. Décision : 'Maintenant ou plus tard ?' Plus tard = plus de marques = plus de dégâts." },
            ...
            new Entry { SpellIdValue = 74, SpellIdTech = "necram_brume_toxique",            ClassId = NymoraClass.Necram, Category = SpellCategory.Offensive, DisplayName = "Brume Toxique",
                Description = "Pose une zone toxique 3x3 pendant 2 tours. Toute unité dans la zone : 60 dégâts immédiats + 1 marque. Toute unité qui ENTRE : 30 dégâts + 1 marque. Toute unité qui FINIT son tour dans la zone : 1 marque additionnelle.",
                LoreFlavor  = "L'air vicié. Brume Toxique ne tue pas — elle CONDAMNE. Les ennemis voient une zone et savent qu'ils ne peuvent pas y mettre les pieds." },
            ...
            new Entry { SpellIdValue = 76, SpellIdTech = "necram_marque_sacrificielle",     ClassId = NymoraClass.Necram, Category = SpellCategory.Tactical,  DisplayName = "Marque Sacrificielle",
                Description = "Pendant 3 tours, les marques sur la cible infligent +20 dégâts par tick. La cible peut recevoir Marque Sacrificielle même si elle n'a pas encore de marques (mais sans marques actives, l'effet est neutre).",
                LoreFlavor  = "L'engrais. Marque Sacrificielle force l'adversaire à se soigner CONSTAMMENT. Un tick à 70 dégâts ne pardonne aucun délai." },
            new Entry { SpellIdValue = 77, SpellIdTech = "necram_symbiose_morbide",         ClassId = NymoraClass.Necram, Category = SpellCategory.Tactical,  DisplayName = "Symbiose Morbide",
                Description = "Pendant 2 tours, chaque tick de venin sur les ennemis soigne le Necram de 8 HP. Cap à 4 marques actives qui comptent pour le heal (donc max +32 HP par tour, +64 sur 2 tours).",
                LoreFlavor  = "Le parasite. Symbiose transforme le Necram en machine à régen. Plus il a de marques sur la map, plus il devient incassable. Anti-attrition par excellence." },
            new Entry { SpellIdValue = 78, SpellIdTech = "necram_contagion",                ClassId = NymoraClass.Necram, Category = SpellCategory.Tactical,  DisplayName = "Contagion",
                Description = "Cible une unité ENNEMIE marquée. Toutes ses marques (cap 3, ou 4 avec PT) sont COPIÉES sur les autres unités ennemies dans un rayon de 3 cases. En 1v1 : la cible reçoit un boost de tick (+1 marque dupliquée sur elle-même).",
                LoreFlavor  = "L'épidémie. En 2v2/3v3, Contagion est dévastateur. En 1v1, elle reste utilisable comme un boost de DoT sur la cible." },
            new Entry { SpellIdValue = 79, SpellIdTech = "necram_pas_spectral",             ClassId = NymoraClass.Necram, Category = SpellCategory.Tactical,  DisplayName = "Pas Spectral",
                Description = "Le Necram gagne +2 PM ce tour ET peut traverser les unités ennemies au prochain déplacement. Ses marques posées par traversée appliquent 1 marque bonus.",
                LoreFlavor  = "Le passage du fantôme. Pas Spectral est l'unique vrai outil de mobilité du Necram. Il l'utilise pour se positionner dans la Brume ou s'extraire d'une mêlée." },
            new Entry { SpellIdValue = 80, SpellIdTech = "necram_voile_pestilence",         ClassId = NymoraClass.Necram, Category = SpellCategory.Survival,  DisplayName = "Voile de Pestilence",
                Description = "Pendant 2 tours, toute unité ennemie qui finit son tour à 2 cases ou moins du Necram reçoit 1 marque automatiquement. Pendant ces 2 tours, toute attaque mêlée subie par le Necram applique 1 marque à l'attaquant.",
                LoreFlavor  = "Le linceul. Voile de Pestilence punit l'adjacence. Une Ghostra qui se téléporte derrière le Necram pour un dorsal se retrouve marquée." },
            new Entry { SpellIdValue = 81, SpellIdTech = "necram_carapace_visqueuse",       ClassId = NymoraClass.Necram, Category = SpellCategory.Survival,  DisplayName = "Carapace Visqueuse",
                Description = "Le Necram gagne un BOUCLIER de 110 HP pour 2 tours. Tout attaquant mêlée qui frappe le bouclier reçoit 1 marque automatiquement.",
            ...
            new Entry { SpellIdValue = 82, SpellIdTech = "necram_drain_vital",              ClassId = NymoraClass.Necram, Category = SpellCategory.Survival,  DisplayName = "Drain Vital",
                Description = "Inflige 60 dégâts à la cible. Le Necram se soigne de 30 HP, ou 60 HP si la cible a 3+ marques actives.",
                LoreFlavor  = "Le siphon. Drain Vital est le heal qui FAIT mal. Sustain économique anti-Soulrender qui presse trop." },
            new Entry { SpellIdValue = 83, SpellIdTech = "necram_regeneration_necrotique",  ClassId = NymoraClass.Necram, Category = SpellCategory.Survival,  DisplayName = "Régénération Nécrotique",
                Description = "Le Necram se soigne de 70 HP + 15 HP par marque ennemis dans rayon 4 (max +90 HP). Avec 1 PT : +30 HP additionnels.",
            ...
            new Entry { SpellIdValue = 85, SpellIdTech = "necram_virus_fatal",              ClassId = NymoraClass.Necram, Category = SpellCategory.Signature, DisplayName = "Virus Fatal",
                Description = "Cible une unité ennemie. TOUTES les marques sur la cible déclenchent leur tick instantanément X3 (multiplicateur Floraison appliqué). Une cible avec 4 marques de venin (50 dmg/tick × 4 × 3) prend 600 dégâts d'un coup. Les marques sont consommées. Si la cible meurt sur ce sort : les marques ne sont PAS consommées et restent disponibles pour Contagion ou Détonation Virulente sur d'autres cibles.",
            ...
            new Entry { SpellIdValue = 87, SpellIdTech = "ghostra_lame_vorace_spectrale",   ClassId = NymoraClass.Ghostra, Category = SpellCategory.Offensive, DisplayName = "Lame Vorace Spectrale",
                Description = "Inflige 130 dégâts + 60 si la cible a PLAIE OUVERTE. Si dorsal : +bonus passif. La Plaie Ouverte n'est PAS consommée.",
                LoreFlavor  = "Le coup qui ronge. Lame Vorace empile sur une plaie ouverte sans la fermer. Ghostra qui a posé une Plaie Ouverte au tour précédent peut la rentabiliser pendant 2 tours." },
            new Entry { SpellIdValue = 88, SpellIdTech = "ghostra_replique_fantome",        ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Réplique Fantôme",
                Description = "Pose un Leurre sur une case vide à 4 cases. Le Leurre est visuellement identique à la Ghostra. Dure 4 rounds (amendement 16 mai 2026) ou jusqu'à interaction. Si le Leurre survit la durée complète, la Ghostra regagne 80 HP. Si le Leurre est détruit par un sort adverse, la Ghostra regagne 40 HP.",
            ...
            new Entry { SpellIdValue = 89, SpellIdTech = "ghostra_pas_dans_ombre",          ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Pas dans l'Ombre",
                Description = "Téléporte la Ghostra jusqu'à 5 cases. Si une case adjacente à l'arrivée contient une cible ennemie : la cible PIVOTE pour faire face à la Ghostra. Coût optionnel : laisser un leurre sur la case quittée (compte dans le cap 3).",
                LoreFlavor  = "Le saut de l'absent. Pas dans l'Ombre n'est pas seulement une mobilité — c'est un GÉNÉRATEUR de leurre." },
            new Entry { SpellIdValue = 90, SpellIdTech = "ghostra_volte_face",              ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Volte-Face",
                Description = "Inflige 80 dégâts (amendement 16 mai 2026) + bonus dorsal Angle Mort si applicable. Force la cible ennemie à faire DEMI-TOUR (180°). Sa direction de regard est inversée instantanément. PAS DE VERROU : la cible se réoriente normalement à son prochain tour (walk / cast / push pivots standard). Si elle ne trigger aucun pivot, elle reste dos → dorsal potentiel sur Lame Spec/Saigne-Âme suivant.",
                LoreFlavor  = "L'ouverture chirurgicale. Volte-Face est désormais un sort OFFENSIF de setup dorsal — il ouvre la cible pour le combo ET tape pour 80. Il transforme une cible en lapin frappé dans le dos." },
            ...
            new Entry { SpellIdValue = 92, SpellIdTech = "ghostra_frappe_fantome",          ClassId = NymoraClass.Ghostra, Category = SpellCategory.Offensive, DisplayName = "Frappe Fantôme",
                Description = "La Ghostra se téléporte à 1 case de la cible (côté libre). Inflige 200 dégâts. Si dorsal : +bonus passif. Si la cible avait été VOLTE-FACE ou que sa direction a été modifiée ce tour : APPLIQUE PLAIE OUVERTE (40/tour × 2t).",
                LoreFlavor  = "Le finisseur. Frappe Fantôme arrive de nulle part. Combinée à Volte-Face, c'est un combo qui peut shred 350+ HP en un tour." },
            new Entry { SpellIdValue = 93, SpellIdTech = "ghostra_dague_lancee",            ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Dague Lancée",
                Description = "Inflige 40 dégâts (amendement 16 mai 2026, nerf 80→40) + bonus dorsal Angle Mort si applicable. Pivot 90° HORAIRE iso de la cible (NE→SE→SW→NW→NE). Flag LastFacingForcedOnTurn posé pour combo Dague→Frappe Fantôme = PlaieOuverte. Cap 2×/tour.",
                LoreFlavor  = "Le caillou dans la vitre. Dague Lancée est l'outil le plus subtile : 1 PA, 40 dégâts, ça paraît minuscule. Mais elle MANIPULE le regard de la cible." },
            new Entry { SpellIdValue = 94, SpellIdTech = "ghostra_marque_ombre",            ClassId = NymoraClass.Ghostra, Category = SpellCategory.Tactical,  DisplayName = "Marque de l'Ombre",
                Description = "Pendant 2 tours, tous les sorts de la Ghostra sur la cible gagnent +20 dégâts. Si la cible est touchée en dorsal pendant ces 2 tours : applique automatiquement PLAIE OUVERTE.",
            ...
            new Entry { SpellIdValue = 95, SpellIdTech = "ghostra_danse_des_lames",         ClassId = NymoraClass.Ghostra, Category = SpellCategory.Offensive, DisplayName = "Danse des Lames",
                Description = "AoE 8 cases adjacentes. Inflige 180 dégâts à toutes les cibles. Toute cible touchée subit le bonus dorsal du passif si dorsale OU si un leurre est adjacent à elle (consommation optionnelle : -1 leurre, applique bonus dorsal automatique).",
                LoreFlavor  = "L'apocalypse en miniature. Danse des Lames est le moment où la Ghostra cesse d'être un assassin et devient un cyclone. Tout converge en une seconde." },
            new Entry { SpellIdValue = 96, SpellIdTech = "ghostra_linceul_ombres",          ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Linceul d'Ombres",
                Description = "La Ghostra gagne un BOUCLIER de 130 HP pendant 2 tours. Toute attaque mêlée subie pendant la durée renvoie 40 dégâts à l'attaquant.",
            ...
            new Entry { SpellIdValue = 97, SpellIdTech = "ghostra_voile_spectral",          ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Voile Spectral",
                Description = "Retire INSTANTANÉMENT tous les DoT actifs sur la Ghostra (saignements, marques venin, plaies). Pendant 1 tour, la Ghostra est immunisée à toute nouvelle application de DoT. UTILISABLE 1x PAR MATCH.",
                LoreFlavor  = "Le seul anti-DoT du kit Ghostra. Sans lui, la Ghostra se fait fondre par Soulrender et Necram. Avec, elle peut plonger dans le brouillard et ressortir propre." },
            new Entry { SpellIdValue = 98, SpellIdTech = "ghostra_replique_protectrice",    ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Réplique Protectrice",
                Description = "Pose un Leurre PROTECTEUR (200 HP, redirige 30% des dégâts subis par la Ghostra pendant 3 rounds) (amendement 16 mai 2026 : 4 PA / 30% / 3 rounds). Si le Leurre est détruit, la Ghostra regagne 80 HP. Pas de stack si plusieurs Protective vivants (un seul absorbe par hit). Compte dans le cap 3 leurres.",
            ...
            new Entry { SpellIdValue = 100, SpellIdTech = "ghostra_pas_au_dela",            ClassId = NymoraClass.Ghostra, Category = SpellCategory.Survival,  DisplayName = "Pas de l'Au-Delà",
                Description = "La Ghostra gagne +2 PM ce tour ET son prochain déplacement ignore les unités (peut traverser ennemis et leurres). Si elle traverse un ennemi, elle déclenche un sort dorsal automatique sur lui (frappe gratuite à 60 dégâts).",
                LoreFlavor  = "Le glissement. Pas de l'Au-Delà transforme la Ghostra en fantôme physique. Anti-Empoignade Soulrender, anti-Mur Colossar." },
