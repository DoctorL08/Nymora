...
namespace Quantum {
  ...
  public unsafe partial struct CombatState : Quantum.IComponentSingleton {
    ...
    [FieldOffset(28)]
    public fixed Int32 TurnOrder[6];
    [FieldOffset(16)]
    public Int32 StartingTeam;
    [FieldOffset(52)]
    public Int32 TurnOrderBuilt;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 6577;
        ...
        fixed (Int32* p = TurnOrder) hash = hash * 31 + HashCodeUtils.GetArrayHashCode(p, 6);
        hash = hash * 31 + StartingTeam.GetHashCode();
        hash = hash * 31 + TurnOrderBuilt.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->StartingTeam);
        serializer.Stream.Serialize(&p->SubTurnInRound);
        serializer.Stream.Serialize(&p->TurnNumber);
        serializer.Stream.SerializeBuffer(&p->TurnOrder[0], 6);
        serializer.Stream.Serialize(&p->TurnOrderBuilt);
  ...
  public unsafe partial struct Combatant : Quantum.IComponent {
    ...
    [FieldOffset(3)]
    [FramePrinter.FixedArrayAttribute(typeof(SpellId), 16)]
    private fixed Byte _CastsThisTurnLog_[16];
    [FieldOffset(24)]
    public Int32 CastsThisTurnCount;
    [FieldOffset(28)]
    public Int32 CastsThisTurnLoggedTurn;
    [FieldOffset(192)]
    public fixed Int32 SpellCooldownLastTurn[110];
    [FieldOffset(176)]
    ...
    public readonly FixedArray<SpellId> CastsThisTurnLog {
      get {
        fixed (byte* p = _CastsThisTurnLog_) { return new FixedArray<SpellId>(p, 1, 16); }
      }
    }
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + TeamOrder.GetHashCode();
        ...
        hash = hash * 31 + HashCodeUtils.GetArrayHashCode(CastsThisTurnLog);
        hash = hash * 31 + CastsThisTurnCount.GetHashCode();
        hash = hash * 31 + CastsThisTurnLoggedTurn.GetHashCode();
        fixed (Int32* p = SpellCooldownLastTurn) hash = hash * 31 + HashCodeUtils.GetArrayHashCode(p, 110);
        hash = hash * 31 + PrescienceGainedThisTurn.GetHashCode();
        hash = hash * 31 + PMSpentLastTurn.GetHashCode();
        hash = hash * 31 + LastEjectedSequence.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FixedArray.Serialize(p->CastsThisTurnLog, serializer, Statics.SerializeSpellId);
        serializer.Stream.Serialize((Byte*)&p->LastCastSpellId);
        serializer.Stream.Serialize(&p->BonusPANextTurn);
        serializer.Stream.Serialize(&p->CastsThisTurnCount);
        serializer.Stream.Serialize(&p->CastsThisTurnLoggedTurn);
        ...
        serializer.Stream.Serialize(&p->LastEjectedSequence);
        ...
        serializer.Stream.Serialize(&p->PMSpentLastTurn);
        serializer.Stream.Serialize(&p->PlayerIndex);
        serializer.Stream.Serialize(&p->PrescienceGainedThisTurn);
        ...
        serializer.Stream.Serialize(&p->TeamOrder);
  ...
  public unsafe partial struct FogSingleton : Quantum.IComponentSingleton {
    public const Int32 SIZE = 4500;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [FramePrinter.FixedArrayAttribute(typeof(FogTile), 225)]
    private fixed Byte _Tiles_[4500];
    public readonly FixedArray<FogTile> Tiles {
      get {
        fixed (byte* p = _Tiles_) { return new FixedArray<FogTile>(p, 20, 225); }
      }
    }
    public override readonly Int32 GetHashCode() {
      unchecked { 
  ...
  public unsafe partial struct GridSingleton : Quantum.IComponentSingleton {
    ...
    public Int32 Height;
    [FieldOffset(8)]
    [FramePrinter.FixedArrayAttribute(typeof(Tile), 225)]
    private fixed Byte _Tiles_[5400];
    public readonly FixedArray<Tile> Tiles {
      get {
        fixed (byte* p = _Tiles_) { return new FixedArray<Tile>(p, 24, 225); }
      }
    }
    public override readonly Int32 GetHashCode() {
      unchecked { 
  ...
  public unsafe partial struct ObstacleSingleton : Quantum.IComponentSingleton {
    public const Int32 SIZE = 1800;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    [FramePrinter.FixedArrayAttribute(typeof(ObstacleTile), 225)]
    private fixed Byte _Tiles_[1800];
    public readonly FixedArray<ObstacleTile> Tiles {
      get {
        fixed (byte* p = _Tiles_) { return new FixedArray<ObstacleTile>(p, 8, 225); }
      }
    }
    public override readonly Int32 GetHashCode() {
      unchecked { 
  ...
  public unsafe partial class Statics {
    public static FrameSerializer.Delegate SerializeSpellId;
    ...
    static partial void InitStaticDelegatesGen() {
      SerializeSpellId = (v, s) => {{ s.Stream.Serialize((Byte*)v); }};
