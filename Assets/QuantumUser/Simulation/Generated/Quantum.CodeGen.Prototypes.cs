...
namespace Quantum.Prototypes {
  ...
  public unsafe partial class CombatStatePrototype : ComponentPrototype<Quantum.CombatState> {
    ...
    public Int32[] TurnOrder = new Int32[6];
    ...
    public void Materialize(Frame frame, ref Quantum.CombatState result, in PrototypeMaterializationContext context = default) {
        ...
        for (int i = 0, count = PrototypeValidator.CheckLength(TurnOrder, 6, in context); i < count; ++i) {
          result.TurnOrder[i] = this.TurnOrder[i];
        }
        result.StartingTeam = this.StartingTeam;
        result.TurnOrderBuilt = this.TurnOrderBuilt;
  ...
  public unsafe class CombatantPrototype : ComponentPrototype<Quantum.Combatant> {
    ...
    public void Materialize(Frame frame, ref Quantum.Combatant result, in PrototypeMaterializationContext context = default) {
        ...
        result.TeamOrder = this.TeamOrder;
        ...
        result.LastPasDansLOmbreOnTurn = this.LastPasDansLOmbreOnTurn;
        result.LastFacingForcedOnTurn = this.LastFacingForcedOnTurn;
        result.LastDagueLanceeOnTurn = this.LastDagueLanceeOnTurn;
  ...
  public unsafe partial class FogSingletonPrototype : ComponentPrototype<Quantum.FogSingleton> {
    ...
    public Quantum.Prototypes.FogTilePrototype[] Tiles = new Quantum.Prototypes.FogTilePrototype[225];
    ...
    public void Materialize(Frame frame, ref Quantum.FogSingleton result, in PrototypeMaterializationContext context = default) {
        for (int i = 0, count = PrototypeValidator.CheckLength(Tiles, 225, in context); i < count; ++i) {
  ...
  public unsafe class GridSingletonPrototype : ComponentPrototype<Quantum.GridSingleton> {
    ...
    public Int32 Height;
    [ArrayLengthAttribute(225)]
    public Quantum.Prototypes.TilePrototype[] Tiles = new Quantum.Prototypes.TilePrototype[225];
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
  ...
  public unsafe class ObstacleSingletonPrototype : ComponentPrototype<Quantum.ObstacleSingleton> {
    [ArrayLengthAttribute(225)]
    public Quantum.Prototypes.ObstacleTilePrototype[] Tiles = new Quantum.Prototypes.ObstacleTilePrototype[225];
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
