...
**Phase actuelle :** 🏆 **PHASE 3 NECRAM CLÔTURÉ** — 4/5 classes complètes (Soulrender + Nightseer + Colossar + Necram). **GHOSTRA EN COURS** Bloc D Phase 3 — **9/16** sorts livrés (Lame Spectrale ✅ + Lame Vorace ✅ + Réplique Fantôme ✅ + Pas dans l'Ombre ✅ + Volte-Face ✅ + Saigne-Âme ✅ + Frappe Fantôme ✅ + Dague Lancée ✅ + **Marque de l'Ombre 🚧 livrée 16 mai E2E à valider**).
**Brique en cours :** **3.7.b.v Marque de l'Ombre** code livré, E2E à faire.
**Brique précédente :** ✅ **3.7.b.i Réplique Fantôme** validée 16 mai E2E (heal expire +80 × 3 confirmé / destruction Charge Brutale OK / Permutation Angle 3 OK).
