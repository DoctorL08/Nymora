...
**Phase actuelle :** 🏆 **PHASE 3 NECRAM CLÔTURÉ** — Necram 16/16 sorts Bible V7.1 conformes E2E validés. Reste Ghostra (0/16, différé post-Phase 4) + IA Hard MCTS (différée).
**Brique en cours :** **À DÉCIDER** — au choix Lorenzo : (a) reprendre Phase 5 reliquats (5.3 Deck builder ?) ; (b) PvP Quantum casu reel (project_pvp_casu_quantum_pending) ; (c) Ghostra Bloc D Phase 3 ; (d) Audit Bible cross-classes Soulrender/Nightseer/Colossar pour la rigueur.
