...
- **PROCHAIN STEP** : (1) **A3 à valider en PvP** (designer Colossar pose murs, Lorenzo les détruit). (2) **GROUPE C — descriptions des ~80 sorts** : revue manuelle contre Bible V7.1 — **Lorenzo le fera lui-même** (décision 22 mai). (3) Polish coinflip : brancher un vrai sprite/anim de pièce designer (placeholder procédural actuel). (4) Push des 7 commits sur origin/main quand Lorenzo stoppe la session.
...
**Phase actuelle :** 🏆 **PHASE 3 CLÔTURÉE — 5/5 CLASSES BIBLE V7.1 COMPLÈTES** (Soulrender + Nightseer + Colossar + Necram + Ghostra 16/16). Polish combat également clos (cf entrée du jour, confirmations 1→6). Phase 4 hub clôturée 15 mai (commit `d36fc2e`). **Reliquats Phase 7 polish conservés (7-8) : Vapeur Carmin multi-case + Empoignade pull refacto.** **Phase 5 prête à démarrer.**
**Brique en cours :** _aucune — entamer Phase 5 bloc 1 (cf [[project-phase5-plan]])_.
