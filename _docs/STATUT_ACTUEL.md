...
**Brique en cours :** **3.5.c.iii Drain Vital** (prochain sort survie Necram) — Bible : 3 PA range 4, 60 dmg + heal Necram 30 HP (ou 60 HP si target a 3+ marques actives). À livrer prochainement.
