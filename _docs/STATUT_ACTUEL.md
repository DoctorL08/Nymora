...
- **PROCHAIN STEP** : (1) **6.7 anti-smurf/anti-boost** (optionnel, détection + flag modération) pour clôturer 100% la Phase 6 ranked OU (2) reprise **Phase 5 reliquats** (boutique 5.5, Battle Pass 5.7, quêtes 5.8) qui n'ont pas de dépendance Kyami, OU (3) cosmétiques 5.9/5.10 quand Kyami livre. **2v2/3v3 = bloc futur** (nécessite bot-fill pour tester à 4/6).
