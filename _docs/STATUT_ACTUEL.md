...
**Phase actuelle :** 🚧 **PHASE 3 NECRAM REPRISE EN PARALLÈLE** (Bloc C survie Necram **5/5 CLÔTURÉ** ce jour) — Décision implicite Lorenzo 16 mai : avancer Necram en parallèle de Phase 5 maintenant que pack visuel + framework venin sont en place.
**Brique en cours :** **3.5.c.vi Virus Fatal** (dernier sort Necram, signature ultime 6/6 PT Putréfaction).
